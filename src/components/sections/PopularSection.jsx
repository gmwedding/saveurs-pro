...
export default function PopularSection() {
  ...
  return (
    <section className="px-4 py-10" style={{ backgroundColor: '#FFFFFF', borderBottom: '1px solid #DDDDE8' }}>
      <div className="flex flex-col items-center gap-2 mb-8">
        <span className="text-[10px] tracking-[0.3em] uppercase" style={{ color: '#EC1C23' }}>
          {isPersonalized ? 'tus pedidos' : 'destacados'}
        </span>
        <h2 className="font-normal" style={{ ...SERIF, fontSize: 'clamp(1.5rem, 4vw, 2.2rem)', color: '#0D1B3E' }}>
          {isPersonalized ? 'Repite tus favoritos' : 'Lo más pedido'}
        </h2>
        <div className="flex items-center gap-3 mt-1">
          <div className="h-px w-10" style={{ backgroundColor: '#DDDDE8' }} />
