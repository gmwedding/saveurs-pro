...
export default function PopularSection() {
  ...
  return (
    <section className="py-12" style={{ backgroundColor: '#FFFFFF', borderBottom: '1px solid #DDDDE8' }}>
      <div className="flex flex-col items-center gap-2 mb-8 px-4">
        ...
        <h2 className="font-normal" style={{ ...SERIF, fontSize: 'clamp(1.6rem, 4vw, 2.4rem)', color: '#0D1B3E' }}>
