      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {items.length > 0 && (
              <div className="px-5 py-5 flex flex-col gap-3" style={{ borderTop: '1px solid #1A2E5A' }}>
                <div className="flex items-center justify-between">
                  <span className="text-[10px] tracking-widest uppercase" style={{ color: '#8A9DC0' }}>Total</span>
