      ...
      {product && (
        <>
          <motion.div
            ...
            style={{ backgroundColor: 'rgba(13,27,62,0.7)', backdropFilter: 'blur(6px)' }}
          />
          <motion.div
            key="modal-panel"
          ...
          >
            ...
            >
              <button
                ...
                style={{ backgroundColor: '#EEF2F8', color: '#0D1B3E' }}
              >
                ✕
              </button>
              ...
              <div
                ...
                style={{ height: '160px', backgroundColor: '#EEF2F8', borderBottom: '1px solid #DDDDE8' }}
              >
                {product.emoji}
              </div>
              ...
              <div className="overflow-y-auto px-6 py-5 flex flex-col gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  <h2 className="font-normal leading-tight" style={{ ...SERIF, fontSize: '1.8rem', color: '#0D1B3E' }}>
                    {product.name}
                  </h2>
                </div>
                ...
                <p className="font-light" style={{ ...SERIF, fontSize: '1.6rem', color: '#0D1B3E', letterSpacing: '0.02em' }}>
                ...
                {qty === 0 ? (
                  <button
                    ...
                    style={{ backgroundColor: '#1C3D79', color: '#FFFFFF' }}
                  >
                    Agregar al pedido
                  </button>
                ) : (
                  <div className="flex items-center gap-3">
                    <div className="flex items-center gap-3 flex-1 justify-center py-2" style={{ border: '1px solid #DDDDE8' }}>
                      <button
                        onClick={() => updateQty(product.id, -1)}
                        className="w-8 h-8 font-black text-base flex items-center justify-center"
                        style={{ backgroundColor: '#EEF2F8', color: '#0D1B3E' }}
                      >−</button>
                      <span className="font-black text-lg w-6 text-center" style={{ color: '#0D1B3E' }}>{qty}</span>
                      <button
                        onClick={() => updateQty(product.id, 1)}
                        className="w-8 h-8 font-black text-base flex items-center justify-center"
                ...
                <button
                  ...
                  style={{ border: '1px solid #DDDDE8', color: '#6A6A6A' }}
                >
                  <WaIcon />
                  Compartir producto
                </button>
